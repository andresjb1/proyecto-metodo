...
function peticionProfesor(txtCarnet, txtNombre, txtApellido, txtbCarnet,numOpcion)
{
    var parametros = {
        "carnet" : txtCarnet,
        "nombre" : txtNombre,
    ...
    var url = "../../Negocio/AdminProfesores.php";
    ...
    $.ajax({
        ...
        success:  function (response) {
            ...
            if(response == 1)
            {
                $("#mensaje1").html("Profesor agregado.");
            }
            else if(response == 2)
            {
            ...
            {
                $("#mensaje1").html("Profesor eliminado.");
            }
            else if(response == 5)
            {
